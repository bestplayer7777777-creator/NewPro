...
scarcitybanner.Text = 'Use /cmd to control other APE players! user: kevinpapa(secret)'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/bestplayer7777777-creator/NewPro/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
